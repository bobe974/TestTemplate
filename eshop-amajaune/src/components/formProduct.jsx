...
const AddProductForm = ({ onSubmit }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-bold mb-6 text-gray-800">Ajouter un produit</h2>
      ...
      <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4">
        ...
        <div>
          ...
          <input 
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          {errors.qte && <p className="text-red-500 text-sm mt-1">{errors.qte.message}</p>}
        </div>
      ...
      {data && (
        <div className="mt-6">
          <h3 className="text-lg font-semibold mb-2 text-gray-800">Données du formulaire :</h3>
